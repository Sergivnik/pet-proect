...
export const ADD_DATA_DRIVER_DEBT_SUCCESS = 'DATA::ADD_DATA_DRIVER_DEBT_SUCCESS';
export const ADD_DATA_DRIVER_DEBT_FAILURE = 'DATA::ADD_DATA_DRIVER_DEBT_FAILURE';
export const DEL_DATA_DRIVER_DEBT_SUCCESS = 'DATA::DEL_DATA_DRIVER_DEBT_SUCCESS';
export const DEL_DATA_DRIVER_DEBT_FAILURE = 'DATA::DEL_DATA_DRIVER_DEBT_FAILURE';
export const EDIT_DATA_DRIVER_DEBT_SUCCESS = 'DATA::EDIT_DATA_DRIVER_DEBT_SUCCESS';
export const EDIT_DATA_DRIVER_DEBT_FAILURE = 'DATA::EDIT_DATA_DRIVER_DEBT_FAILURE';
...
export const DEL_DRIVER_PAYMENT_SUCCESS_ORDER = 'DEL_DRIVER_PAYMENT_SUCCESS_ORDER';
export const DEL_DRIVER_PAYMENT_SUCCESS_DRIVER = 'DEL_DRIVER_PAYMENT_SUCCESS_DRIVER';
...
export const makePaymentDriver = (idDriver, chosenOders, chosenDebts, currentDriverSumOfOders) => {
  return dispatch =>
    axios
