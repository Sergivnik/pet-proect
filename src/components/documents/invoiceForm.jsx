  ...
  const handleEnter = useCallback(
    e => {
      if (e.keyCode === 13) {
        ...
        const adjustedStart = strInvoiceNumber[start] === ' ' ? start + 1 : start;
          ...
          <tbody>
            <tr style={{ lineHeight: '1' }}>
              <td style={{ ...styles.tableCell, width: '34.3%' }}>
                ИНН {currentOwner && currentOwner.TIN ? currentOwner.TIN : ''}
              </td>
              ...
              <td style={{ ...styles.tableCell, width: '25.7%' }}>
                {currentOwner && currentOwner.Acc ? currentOwner.Acc : ''}
              </td>
            </tr>
            <tr style={{ lineHeight: '1' }}>
              <td style={styles.tableCell} colSpan={2}>
                {currentOwner && currentOwner.fullNameOwner ? currentOwner.fullNameOwner : '—'}
                <br />
                <span
                  style={{
                    fontSize: '12px',
            ...
            <tr style={{ lineHeight: '1' }}>
              <td style={styles.tableCell} rowSpan="2" colSpan={2}>
                {currentOwner && currentOwner.bankName && currentOwner.bankAddress
                  ? `${currentOwner.bankName} ${currentOwner.bankAddress}`
                  : '—'}
                <br />
                <span
                  style={{
