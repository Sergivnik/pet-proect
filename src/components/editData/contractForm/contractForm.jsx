      ...
      <div className="contractContentDiv">
        <div className="contractContentWrapper">
          <header className="contractHeader">
            ...
            <h4 className="contractHeaderH4">на оказание транспортно-экспедиционных услуг.</h4>
          ...
          <section>
            ...
            <article>
              ...
              <EditP>
                ...
                неотъемлемой частью настоящего договора и основанием для составления УПД.{' '}
              </EditP>
            </article>
          </section>
          <section>
            ...
            <article>
              <EditP>
                ...
                согласуется сторонами в УПД, подписываемом сторонами.
              </EditP>
              <EditP>
          ...
          <section>
            ...
            <article>
              ...
              <EditP>
                3.2.10. по получении УПД подписать его и направить Экспедитору.
              </EditP>
            </article>
          </section>
          <section>
            ...
            <article>
              ...
              <EditP>
                ...
                течении семи банковских дней с момента предоставления Экспедитором Счета, УПД и товарно-транспортных документов с отметками получателя на
              ...
              <EditP>
                ...
                факсу/электронной почте счет на оплату за грузоперевозку, а УПД
